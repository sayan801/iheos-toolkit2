...
public void runMDN() throws Exception {
		...
		msg = MDNGenerator.createSignedAndEncrypted("Automatic MDN", "ttt", "Security Agent", this.toAddress, this.fromAddress, 
				originalMsgId, "automatic-action/MDN-sent-automatically;processed", this.fromAddress, this.toAddress, 
