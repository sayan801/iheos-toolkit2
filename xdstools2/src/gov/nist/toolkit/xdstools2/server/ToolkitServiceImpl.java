...
//	public String getToolkitEnableNwHIN() { return propertyServiceManager.getToolkitEnableNwHIN(); }
	...
	public List<String> getTransInstances(SimId simid, String trans) throws Exception { return new SimulatorServiceManager(session()).getTransInstances(simid, trans); }
	public String getTransactionRequest(SimId simid, String trans, String event) throws NoServletSessionException { return new SimulatorServiceManager(session()).getTransactionRequest(simid, trans, event); }
	public String getTransactionResponse(SimId simid, String trans, String event) throws NoServletSessionException { return new SimulatorServiceManager(session()).getTransactionResponse(simid, trans, event); }
	...
	public String getTransactionLog(SimId simid, String trans, String event) throws NoServletSessionException { return new SimulatorServiceManager(session()).getTransactionLog(simid, trans, event); }
